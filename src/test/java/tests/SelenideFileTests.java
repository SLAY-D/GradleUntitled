...
public class SelenideFileTests {
    ...
    public void readPDFTest() throws IOException {
        ...
        String pdfFileText = pdfreader.text;
        Assertions.assertTrue(pdfFileText.contains("AC-Tester"));
    }

    @Test
    public void readDownloadPDFTest() throws IOException {
        Selenide.open("https://pdf995.com/samples/");
    ...
    public void readXlsxBrowserTest() throws Exception {
        Selenide.open("https://wisdomaxis.com/technology/software/data/for-reports/");
        File orderWithNulls = $x("//a[@download='Orders-With Nulls.xlsx']").download();
        XlsReader xlsReader = new XlsReader(orderWithNulls);
        String[][] data = xlsReader.getSheetData();
